                                    ...
                                    <div class="products">
                                        <div class="product">		
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="product_details.php?id=<?php echo $category_product['product_id']; ?>"><img  src="assets/<?php echo $category_product['product_image']; ?>" data-echo="assets/<?php echo $category_product['product_image']; ?>" alt="" height="200" width="200"></a>
                                                </div><!-- /.image -->            		   
                                            </div><!-- /.product-image -->
                                            <div class="product-info text-left">
                                                ...
                                                <div class="product-price">	
                                                    <span class="price"> BDT <?php echo $category_product['product_price']; ?></span>
                                                </div><!-- /.product-price -->
                                            </div><!-- /.product-info -->
