                ...
                <div class="row  wow fadeInUp">
                        ...
                        <div class="product-item-holder size-big single-product-gallery small-gallery">
                            <div id="owl-single-product">
                                <div class="single-product-gallery-item" id="slide1">
                                    <a data-lightbox="image-1" data-title="Gallery" href="assets/<?php echo $product_info['product_image']; ?>">
                                        <img class="img-responsive" alt="" src="assets/<?php echo $product_info['product_image']; ?>" data-echo="assets/<?php echo $product_info['product_image']; ?>" />
                                    </a>
                    ...
                    <div class='col-sm-6 col-md-7 product-info-block'>
                        <div class="product-info">
                            <h1 class="name"><?php echo $product_info['product_name']; ?></h1>
                            ...
                            <div class="stock-container info-container m-t-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="stock-box">
                                            <span class="value"><?php echo $product_info['category_name']; ?></span>
                                        </div>	
                                    </div>
                                </div><!-- /.row -->	
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="stock-box">
                                            <span class="value"> <?php echo $product_info['manufacturer_name']; ?></span>
                                        </div>	
                                    </div>
                                </div><!-- /.row -->	
                            </div><!-- /.stock-container -->
                            ...
                            <div class="description-container m-t-20">
                               <p class="text"><?php echo $product_info['product_short_description']; ?></p>
                            ...
                            <div class="price-container info-container m-t-20">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="price-box">
                                            <span class="price">BDT <?php echo $product_info['product_price']; ?></span>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text"><?php echo $product_info['product_long_description']; ?></p>
                                    </div>	
                                </div><!-- /.tab-pane -->
